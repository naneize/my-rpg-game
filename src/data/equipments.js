// ✅ equipments.js (The Grand Collection - 75 Items Reworked)
export const EQUIPMENTS = [
  ...
  { id: 'oak_slingshot', name: 'Oak Wood Slingshot', slot: 'weapon', rarity: 'Common', icon: '🏹', atk: 18, description: 'Basic ranged weapon.', color: 'text-slate-400' },
  { id: 'rusty_dagger', name: 'Rusty Kitchen Knife', slot: 'weapon', rarity: 'Common', icon: '🔪', atk: 22, description: 'Old but still cuts.', color: 'text-slate-400' },
  ...
  { id: 'iron_mace', name: 'Heavy Iron Mace', slot: 'weapon', rarity: 'Uncommon', icon: '🔨', atk: 55, pen: 0.02, color: 'text-emerald-400' },
  { id: 'scout_bow', name: 'Composite Scout Bow', slot: 'weapon', rarity: 'Uncommon', icon: '🏹', atk: 50, critRate: 0.05, color: 'text-emerald-400' },
  { id: 'poison_ivy_blade', name: 'Poison Ivy Blade', slot: 'weapon', rarity: 'Rare', icon: '🍃', atk: 120, atkPercent: 0.12, pen: 0.08, color: 'text-blue-400' },
  { id: 'elven_longbow', name: 'Elven Heritage Longbow', slot: 'weapon', rarity: 'Rare', icon: '🏹', atk: 135, critRate: 0.10, critDamage: 0.20, color: 'text-blue-400' },
  { id: 'wind_slicer', name: 'Wind Slicer Katana', slot: 'weapon', rarity: 'Rare', icon: '🎋', atk: 125, atkPercent: 0.10, critRate: 0.12, color: 'text-blue-400' },
  { id: 'serpent_fang_dagger', name: 'Serpent Fang Dagger', slot: 'weapon', rarity: 'Epic', icon: '🐍', atk: 350, pen: 0.15, critRate: 0.15, color: 'text-purple-400' },
  { id: 'magma_breaker', name: 'Magma Breaker Hammer', slot: 'weapon', rarity: 'Epic', icon: '🌋', atk: 420, pen: 0.25, description: 'Crushes any armor.', color: 'text-purple-400' },
  { id: 'plasma_cutter', name: 'High-Freq Plasma Blade', slot: 'weapon', rarity: 'Epic', icon: '🔦', atk: 380, atkPercent: 0.25, pen: 0.10, color: 'text-purple-400' },
  { id: 'void_reaver_blade', name: 'VOID REAVER BLADE', slot: 'weapon', rarity: 'Legendary', icon: '🌌', atk: 950, atkPercent: 0.50, critRate: 0.25, critDamage: 1.0, pen: 0.35, color: 'text-purple-500' },
  { id: 'storm_caller_bow', name: 'STORM CALLER BOW', slot: 'weapon', rarity: 'Legendary', icon: '⚡', atk: 880, atkPercent: 0.45, critRate: 0.35, critDamage: 0.8, color: 'text-orange-500' },
  { id: 'genesis_claymore', name: 'GENESIS TERRA BLADE', slot: 'weapon', rarity: 'Legendary', icon: '🗿', atk: 1100, pen: 0.50, def: 200, color: 'text-orange-500' },
  ...
  { id: 'iron_shield_armor', name: 'Rusty Iron Plate', slot: 'armor', rarity: 'Uncommon', icon: '🛡️', def: 35, hp: 150, defPercent: 0.05, color: 'text-emerald-400' },
  ...
  { id: 'wind_essence', name: 'Gale Wind Essence', slot: 'accessory', rarity: 'Rare', icon: '🌪️', luck: 15, critRate: 0.08, color: 'text-blue-400' },
  ...
  { id: 'nature_emblem', name: 'Emblem of the Forest', slot: 'accessory', rarity: 'Epic', icon: '🏵️', hp: 2500, hpPercent: 0.15, color: 'text-purple-400' },
  { id: 'warrior_spirit_pendant', name: 'Warrior Spirit Gem', slot: 'accessory', rarity: 'Epic', icon: '🎖️', atkPercent: 0.20, critRate: 0.10, color: 'text-purple-400' },
  ...
  { id: 'chaos_shiver', name: 'CHAOS REALITY CORE', slot: 'accessory', rarity: 'Legendary', icon: '⚛️', atkPercent: 0.60, pen: 0.20, color: 'text-orange-500' },
  ...
  { id: 'rope_belt', name: 'Sturdy Hemp Rope', slot: 'belt', rarity: 'Common', icon: '🧶', hp: 50, color: 'text-slate-400' },
  { id: 'fabric_sash', name: 'Old Fabric Sash', slot: 'belt', rarity: 'Common', icon: '🧣', def: 8, color: 'text-slate-400' },
  { id: 'snake_skin_belt', name: 'Snake Skin Belt', slot: 'belt', rarity: 'Uncommon', icon: '🐍', def: 15, critRate: 0.03, color: 'text-emerald-400' },
  { id: 'insect_molt_belt', name: 'Chitin Belt', slot: 'belt', rarity: 'Uncommon', icon: '🐚', def: 40, hp: 100, color: 'text-emerald-400' },
  { id: 'beast_hide_belt', name: 'Thick Beast Hide', slot: 'belt', rarity: 'Uncommon', icon: '🐻', def: 25, hp: 250, color: 'text-emerald-400' },
  { id: 'silver_chain_belt', name: 'Polished Silver Chain', slot: 'belt', rarity: 'Rare', icon: '⛓️', def: 80, critDamage: 0.15, color: 'text-blue-400' },
  { id: 'river_mud_belt', name: 'Hardened Mud Sash', slot: 'belt', rarity: 'Rare', icon: '💩', def: 120, hp: 500, color: 'text-blue-400' },
  { id: 'wind_silk_belt', name: 'Gale Silk Belt', slot: 'belt', rarity: 'Rare', icon: '🎀', critRate: 0.08, luck: 10, color: 'text-blue-400' },
  ...
  { id: 'volcano_belt', name: 'LAVA FLOW SASH', slot: 'belt', rarity: 'Epic', icon: '🔥', def: 300, hp: 1500, reflect: 0.10, color: 'text-purple-400' },
  { id: 'titanium_belt', name: 'TITANIUM PLATED BELT', slot: 'belt', rarity: 'Epic', icon: '🔩', def: 450, defPercent: 0.30, color: 'text-purple-400' },
  { id: 'neural_link_belt', name: 'NEURAL LINK SASH', slot: 'belt', rarity: 'Epic', icon: '🌐', atkPercent: 0.15, critRate: 0.12, color: 'text-purple-400' },
  { id: 'world_spine_belt', name: 'WORLD SPINE BELT', slot: 'belt', rarity: 'Legendary', icon: '🦴', hp: 8000, def: 600, defPercent: 0.50, color: 'text-orange-500' },
  { id: 'void_orbit', name: 'VOID ORBITAL BELT', slot: 'belt', rarity: 'Legendary', icon: '🪐', pen: 0.30, critDamage: 1.20, color: 'text-purple-500' },
  ...
  { id: 'eagle_eye', name: 'Eagle Eye Charm', slot: 'trinket', rarity: 'Rare', icon: '👁️', critRate: 0.15, critDamage: 0.20, color: 'text-blue-400' },
  { id: 'toxic_vial', name: 'Concentrated Venom', slot: 'trinket', rarity: 'Rare', icon: '🧪', pen: 0.12, atk: 50, color: 'text-blue-400' },
  { id: 'abyssal_eye_pendant', name: 'ABYSSAL EYE PENDANT', slot: 'trinket', rarity: 'Legendary', icon: '👁️', atkPercent: 0.25, critRate: 0.20, critDamage: 0.80, pen: 0.25, color: 'text-cyan-400' },
  { id: 'phoenix_ember', name: 'ETERNAL PHOENIX EMBER', slot: 'trinket', rarity: 'Epic', icon: '☀️', hp: 2000, hpPercent: 0.20, reflect: 0.12, color: 'text-purple-400' },
  { id: 'ghost_shard', name: 'Ethereal Ghost Shard', slot: 'trinket', rarity: 'Epic', icon: '👻', luck: 40, critRate: 0.15, color: 'text-purple-400' },
  { id: 'dragon_heart', name: 'DRAGON HEART CORE', slot: 'trinket', rarity: 'Epic', icon: '❤️', hp: 5000, atkPercent: 0.15, color: 'text-purple-400' },
