...
export function useCombat(player, setPlayer, setLogs, advanceDungeon, exitDungeon, inDungeon, collectionBonuses, mapControls) { 
  ...
  const handleAttack = () => {
    ...
    setTimeout(() => {
      ...
      // ✅ ประมวลผล Passive ผู้เล่น (คงเดิม)
